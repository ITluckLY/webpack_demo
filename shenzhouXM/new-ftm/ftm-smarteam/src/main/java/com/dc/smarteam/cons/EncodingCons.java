 ...
 */
public class EncodingCons {//NOSONAR
    public static final String DEF_ENCODING = "UTF-8";
    public static final String XML_FILE_DEF_ENCODING = DEF_ENCODING;
    public static final Charset XML_FILE_DEF_CHARSET = Charset.forName(XML_FILE_DEF_ENCODING);
    public static final String PROPERTIES_FILE_DEF_ENCODING = DEF_ENCODING;
    ...
    //cfg配置文件的编码
    public static final String CFG_CONTENT_ENCODING = DEF_ENCODING;
    public static final Charset CFG_CONTENT_CHARSET = Charset.forName(CFG_CONTENT_ENCODING);
    public static final String CFG_CONTENT_IN_DB_ENCODING = DEF_ENCODING;
