...
//    @RequiresPermissions("sys:user:view")1
    ...
    public Object list(User user, HttpServletRequest request, HttpServletResponse response) {
...
//    @RequiresPermissions("sys:user:view")
    ...
    public Object form(String message, User user) {
        ...
        return PublicRepResultTool.sendResult("0000", StringUtils.isBlank(message)? "成功":message,resultMap);
    }

//    @RequiresPermissions("sys:user:view")
    @RequestMapping(value = "editForm")
    public Object editForm(User user) {
...
//    @RequiresPermissions("sys:user:edit")
    ...
    public Object delete(User user) {
        ...
        log.debug("message:{}",message);
        return PublicRepResultTool.sendResult("删除用户成功".equals(message)? "0000":"9999",message,null);
    }
//
//    /**
//     * 导出用户数据
...
//            new ExportExcel("用户数据", user.getClass()).setDataList(page.getList()).write(response, fileName).dispose();
//            return null;
//        } catch (Exception e) {
