...
import com.dc.smarteam.modules.sys.dao.*;
import com.dc.smarteam.modules.sys.entity.*;
 ...
 * @version 2013-12-05
 */
public class UserUtils {//NOSONAR
    ...
    public static void clearCache(User user) {
        ...
        CacheUtils.remove(USER_CACHE, USER_CACHE_LOGIN_NAME + user.getLoginName());
        CacheUtils.remove(USER_CACHE, USER_CACHE_LOGIN_NAME + user.getOldLoginName());
        if (user.getOffice() != null && user.getOffice().getId() != null) {
            CacheUtils.remove(USER_CACHE, USER_CACHE_LIST_BY_OFFICE_ID + user.getOffice().getId());
        }
    }
