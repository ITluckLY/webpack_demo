...
public class ZxingHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(ZxingHandler.class);
    /**
     * 条形码编码
     *
     * @param contents
    ...
    public static void encode2(String contents, int width, int height, String imgPath) {
        Hashtable<EncodeHintType, Object> hints = new Hashtable<>();//NOSONAR
        // 指定纠错等级
    ...
    public static String decode2(String imgPath) {
        ...
        try {
            ...
            Hashtable<DecodeHintType, Object> hints = new Hashtable<>();//NOSONAR
    ...
    public static void main(String[] args) {
        ...
        log.debug("finished zxing EAN-13 encode.");

        String decodeContent = ZxingHandler.decode(imgPath);
        log.debug("解码内容如下:{}", decodeContent);
        log.debug("finished zxing EAN-13 decode.");
        ...
        log.debug("解码内容如下:{}", decodeContent2);
