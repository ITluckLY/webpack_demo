...
import com.dc.smarteam.service.ServiceInfoImportsService;
...
@Service("UserImportsServiceImpl")
public class UserImportsServiceImpl implements UserImportsService {

    private static Logger log = LoggerFactory.getLogger(UserImportsServiceImpl.class);
     ...
     * @return
     */
    public ResultDto<HashMap<String, String[]>> getDataMap(File file, String nodesystemname, String banksystemname) {//NOSONAR
     ...
     * @return
     */
    public ResultDto checkeff(String[] importdata, String banksystemname) {
...
//            return ResultDtoTools.buildError("IP地址[" + address + "]" + errorrex);
//        }
       ...
       /* String[] addmins = address.split("\\.");
        for (String addmin : addmins) {
            if (Integer.parseInt(addmin) >255 || Integer.parseInt(addmin) < 0) {
                ...
                return ResultDtoTools.buildError("address[" + address + "]" + errorrex);
            }
        }*/
    ...
    public void saveSystemModel(SystemModel model) {
