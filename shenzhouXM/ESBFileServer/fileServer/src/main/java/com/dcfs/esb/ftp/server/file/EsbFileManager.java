 ...
 * 文件系统管理工厂
 */
public class EsbFileManager {
    public static final String OP_W = "W";
    public static final String OP_R = "R";
    public static final String OP_A = "A";
    private static final Logger log = LoggerFactory.getLogger(EsbFileManager.class);
    private static EsbFileManager instance = null;
    ...
    public static EsbFileManager getInstance() {
        reload();
        return instance;
    }
    ...
    public static void reload() {
        ...
        EsbFileManager inst = new EsbFileManager();
        inst.load();
        instance = inst;
    }
    ...
    public void load() {
        ...
        backupRootpath = FtpConfig.getInstance().getFileBackupRootPath();
     ...
     * @throws FtpException
     */
    public boolean isAuthToUser(String filePath, String user, String op) throws FtpException {
    ...
    private boolean checkUserAuth(String filePath, String user, String op) throws FtpException {//NOSONAR
        ...
        for (UserPathAuth auth : list) {
            ...
            if (filePath.startsWith(fileName)) {
                ...
                if (StringUtils.equalsIgnoreCase(authType, op) || StringUtils.equalsIgnoreCase(EsbFileManager.OP_A, authType)) {
    ...
    public String getFileAbsolutePath(String fileName) {
        FileNameUtils.checkJumpSymbol(fileName);
