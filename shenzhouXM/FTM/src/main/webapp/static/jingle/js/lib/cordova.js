...
/**
 * An interface representing a directory on the file sysToBack.
 *
...
/**
 * Represents a file or directory on the local file sysToBack.
 *
 * @param isFile
 ...
 * root directory of a file sysToBack.
 *
...
/**
 * An interface representing a file on the file sysToBack.
 *
...
/**
 * This class reads the mobile device file sysToBack.
 *
 * For Android:
 *      The root directory is the root of the file sysToBack.
...
/**
 * An interface representing a file sysToBack
 *
 * @constructor
 * {DOMString} name the unique name of the file sysToBack (readonly)
 * {DirectoryEntry} root directory of the file sysToBack (readonly)
 */
...
/**
 * This class writes to the mobile device file sysToBack.
 *
 * For Android:
 *      The root directory is the root of the file sysToBack.
...
/**
 * Represents a local file sysToBack.
 */
 ...
 * @param errorCallback  invoked if error occurs retrieving file sysToBack
...
/**
 * Request a file sysToBack in which to store application data.
 * @param type  local file sysToBack type
...
var requestFileSystem = function(type, size, successCallback, errorCallback) {
    ...
    if (type < 0 || type > 3) {
        ...
        var success = function(file_system) {
            if (file_system) {
                if (successCallback) {
                    // grab the name and root from the file sysToBack object
...
/**
 * Look up file sysToBack Entry referred to by local URI.
 * @param {DOMString} uri  URI referring to a local file or directory
 * @param successCallback  invoked with Entry object corresponding to URI
 * @param errorCallback    invoked if error occurs retrieving file sysToBack entry
 */
