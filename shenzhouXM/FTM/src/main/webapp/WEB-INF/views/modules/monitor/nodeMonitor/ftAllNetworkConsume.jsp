        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (i, item) {
                    if (item.system != null) {
                        $("#container").append("<div id=\'networkConsume" + i + "\' style='height:400px; width: 90%;'></div>");
                        $('#networkConsume' + i + '').highcharts('StockChart', {
                            chart: {
                                renderTo: "container",
                                events: {
                                    load: function () {
                                        ...
                                        setInterval(function () {
                                            $.ajax({
                                                url: '${ctx}/monitor/FtNodeMonitor/network?node=' + item.node,
                                                type: "get",
                                                dataType: 'json',
                                                success: function (data) {
