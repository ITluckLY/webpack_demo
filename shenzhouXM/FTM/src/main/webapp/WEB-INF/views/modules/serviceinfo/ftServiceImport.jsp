...
<form:form id="inputForm" modelAttribute="bankSystem" action="${ctx}/serviceinfo/ftServiceImports/save" method="post"
           class="form-horizontal" enctype="multipart/form-data">
    <sys:message content="${message}"/>
    <div class="control-group">
        <label class="control-label">模板下载:</label>
        <div class="controls">
            <a href="${ctx}/serviceinfo/ftServiceImports/download?filename=codes_model.csv">
                系统名_联系人_交易码申请单.csv
            </a>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <form:select id="bankname" path="bankname" class="input-medium" style="width:150px" required="true">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="serviceinfo:ftServiceImports:edit"><input id="btnSubmit" class="btn btn-primary"
                                                                             type="submit"
