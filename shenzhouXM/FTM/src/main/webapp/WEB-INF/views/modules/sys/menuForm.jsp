...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="20" class="required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="80" class="input-xxlarge"/>
			</div>
		</div>
