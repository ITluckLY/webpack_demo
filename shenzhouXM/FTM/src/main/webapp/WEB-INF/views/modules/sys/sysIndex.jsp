...
//							return addTab($(this));
		...
		function addTab($this, refresh){
		    /*var currentPage = $this[0].innerText.trim();
            var allContent = $("#jerichotab")[0].textContent.trim();
            var allContentArray = allContent.split("×");
            for(var i =0;i<allContentArray.length;i++){
                if(currentPage == allContentArray[i]){
					myrefresh();
                }
            }*/
			$(".jericho_tab").show();
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right" modelAttribute="ftServiceNode">
					...
					<%--<li><a href=""><i class="icon-signal"></i></a></li>--%>
                        <li><a href="${ctx}/servicenode/ftServiceNode/set" target="mainFrame" onblur="myrefresh()">当前节点组 ：
                        ${ftServiceNode.systemName!=null?ftServiceNode.systemName:"未选定节点组"}
						</a></li>
						<%--<li><a>当前节点 ：
							${ftServiceNode.name!=null?ftServiceNode.name:"未选定节点"}
						</a></li>--%>
<%--
					<li><a href="${ctx}/servicenode/ftServiceNode/nodeList" target="mainFrame">&lt;%&ndash;<i class="icon-home"></i>&ndash;%&gt;&nbsp;</a></li>
--%>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://jeesite.com" target="_blank">Dcits</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript">
