...
<body>
<br/>
<form:form id="inputForm" modelAttribute="clientSyn" action="${ctx}/client/clientSyn/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="username" htmlEscape="false" maxlength="20" class="input-xlarge " required="true"
                        style="WIDTH: 250px" id="username"/>
            <span class="help-inline"><font color="red"> * </font>英文字母开头+英文、数字或下划线的组合（3-20位）</span>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="client:clientSyn:edit"> <input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;
        </shiro:hasPermission>
