...
<ul class="nav nav-tabs nav-tabs-hidden">
    ...
    <li class="active"><a href="${ctx}/route/ftRoute/addPage?id=${ftRoute.id}&tran_code=${ftRoute.tran_code}">路由管理<shiro:hasPermission
            name="route:ftRoute:edit">添加</shiro:hasPermission><shiro:lacksPermission name="route:ftRoute:edit">修改</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="ftRoute" action="${ctx}/route/ftRoute/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="tran_code" class="input-xlarge" style="WIDTH:265PX">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="user" class="input-xlarge" style="WIDTH:265PX">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="destination" class="input-xlarge" style="WIDTH:265PX" multiple="true">
                <form:options items="${sysProtocolList}" itemLabel="name" itemValue="name" htmlEscape="false"/>
            </form:select>
        </div>
    </div>
