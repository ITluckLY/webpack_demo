...
<script type="text/javascript">
    ...
    var downsum=0;
    $.ajax({
        url: '${ctx}/monitor/FtTransforMonitor/findDownloadFailPerHour?nodeName='+nodeName+'&sysname='+sysname,
        type: "get",
        dataType:'json',
        success: function(data){
            ...
            $('#downloadcontainer').highcharts('StockChart', {
                ...
                title : {
                    text : sysname+'节点组'+nodeName+'节点'+'文件下载失败(总数：'+downsum+')',
                },
                credits: {
                    enabled:false
                },
...
//                },
    ...
    $.ajax({
        url: '${ctx}/monitor/FtTransforMonitor/findUploadFailPerHour?nodeName='+nodeName+'&sysname='+sysname,
        type: "get",
        dataType:'json',
        success: function(data){
            $.each(data, function(i,item) {
            ...
            $('#uploadcontainer').highcharts('StockChart', {
                ...
                title : {
                    text : sysname+'节点组'+nodeName+'文件上传失败(总数：'+upsum+')',
                },
                credits: {
                    enabled:false
                },
