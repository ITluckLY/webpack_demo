...
<body>
<br/>
<form:form id="inputForm" modelAttribute="clientSyn" action="${ctx}/client/clientSyn/saveEdit" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <shiro:hasPermission name="client:clientSyn:edit">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="client:clientSyn:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
