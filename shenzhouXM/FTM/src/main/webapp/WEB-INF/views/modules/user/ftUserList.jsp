...
<ul class="nav nav-tabs nav-tabs-hidden">
  ...
  <shiro:hasPermission name="user0:ftUser:edit">
    <li><a href="${ctx}/user/ftUser/addPage">用户管理添加</a></li>
  </shiro:hasPermission>
</ul>
...
<form:form id="searchForm" modelAttribute="ftUser" action="${ctx}/user/ftUser/" method="post"
    ...
    <tr>
      ...
      <shiro:hasPermission name="user0:ftUser:edit">
        <td>
          ...
          <a href="${ctx}/user/ftUser/delete?name=${ftUser.name}"
