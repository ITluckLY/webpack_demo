...
<body>
	<ul class="nav nav-tabs nav-tabs-hidden">
		...
		<li class="active"><a href="${ctx}/serviceinfo/ftServiceInfo/form?trancode=${ftServiceInfo.trancode}&systemName=${ftServiceInfoTemp.systemName}">服务管理<shiro:hasPermission name="serviceInfo:ftServiceInfo:edit">修改</shiro:hasPermission><shiro:lacksPermission name="serviceInfo:ftServiceInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ftServiceInfo" action="${ctx}/serviceinfo/ftServiceInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">交易码：</label>
			<div class="controls">
				<form:input path="trancode" htmlEscape="false" maxlength="20" class="input-xlarge"  readonly="true" style="WIDTH:250PX"/>
			</div>
		</div>
        <div class="control-group">
            <label class="control-label">节点组：</label>
            <div class="controls">
                <form:input path="systemName" htmlEscape="false" maxlength="20" class="input-xlarge " required="true" style="WIDTH:250PX" disabled="true"/>
            </div>
        </div>
		<%--<div class="control-group">
			<label class="control-label">相关流程：</label>
			<div class="controls">
				<form:input path="flow" htmlEscape="false" maxlength="256" class="input-xlarge "/>
			</div>
		</div>--%>
		<div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="filePeriod" htmlEscape="false" maxlength="8" class="input-xlarge " style="WIDTH:250PX"  required="true"
