...
<head>
    ...
    <script type="text/javascript">
        ...
        function getParam(){
            $.ajax({
                url: "${ctx}/client/clientSyn/getParam?fileName=FtsApiConfig.properties",
                type: "post",
        ...
        $(function() {
            ...
            $("#sure").click(function(){
                ...
                $.ajax({
                    type:'post',
                    url:'${ctx}/client/clientSyn/editCfg?fileName=FtsApiConfig.properties',
            ...
            $("#sync").click(function(){
                if(confirm("确定同步客户端参数么")){
                    $.ajax({
                        url: "${ctx}/client/clientSyn/sync?fileName=FtsApiConfig.properties",
                        type: "get",
                        success: function () {
                            alert("客户端参数同步完成");
                            window.location.reload();
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/client/clientSyn/ftsApiCfg">FtsApiConfig</a></li>
