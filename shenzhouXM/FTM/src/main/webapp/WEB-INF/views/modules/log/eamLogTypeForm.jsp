...
<body>
	...
	<form:form id="inputForm" modelAttribute="eamLogType" action="${ctx}/log/eamLogType/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="logRange" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">日志清理规则：</label>
			<div class="controls">
				<form:input path="logCleanType" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
