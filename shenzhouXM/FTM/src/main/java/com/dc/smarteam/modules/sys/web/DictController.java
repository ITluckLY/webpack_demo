...
public class DictController extends BaseController {
    ...
    public String list(Dict dict, HttpServletRequest request, HttpServletResponse response, Model model, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            addMessage(redirectAttributes, "查询字典信息失败！详情：" + e.getMessage());
