...
public class FtNodeParamController extends BaseController {
    ...
    public String list(FtServiceNode ftServiceNode, HttpServletRequest request, HttpServletResponse response, Model model, RedirectAttributes redirectAttributes) {
        ...
        model.addAttribute("ftNodeParamList", list);
        return "modules/nodeparam/ftNodeParamList";
    }
