...
public class FtNodeGroupController extends BaseController {
    ...
    public String nodeList(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        model.addAttribute("ftSysInfoList", ftSysInfoList2);
        FtServiceNode ftServiceNode = CurrNameNodeHelper.getCurrNameNode(request);
        if (ftServiceNode != null) {
            model.addAttribute("ftServiceNode", ftServiceNode);//NOSONAR
            ftServiceNodeNameNode.setSystemName(ftServiceNode.getSystemName());
        } else {
            model.addAttribute("ftServiceNode", ftServiceNodeNameNode);
        }
        ...
        return "modules/servicenode/ftServiceNodeSet";//NOSONAR
    }
