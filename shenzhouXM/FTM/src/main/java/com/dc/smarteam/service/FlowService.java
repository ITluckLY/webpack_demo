...
public class FlowService extends AbstractService {
    ...
    public ResultDto<String> add(FtFlow ftFlow) {
        ...
        /*if (StringUtils.isEmpty(ftFlow.getComponents())) {
            return ResultDtoTool.buildError("组件不能为空");
        }*/
    ...
    private static final String CFG_PSFLOW_NAME = "file_process.xml";
    ...
    private void save(FlowModel model) {
      ...
      /*
        ...
        for(FlowModel.Flow ss : model.getFlows()){
            if(ss.getName().equals("FilesProcesFlow")){
                psflowname =CFG_PSFLOW_NAME;
            }else {
                psflowname =CFG_FILE_NAME;
    ...
    public String getCfgPsFileName() {
        return CFG_PSFLOW_NAME;
    }
