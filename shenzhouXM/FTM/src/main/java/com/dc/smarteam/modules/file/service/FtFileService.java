...
public class FtFileService extends CrudService<FtFileDao, FtFile> {
    private static final Logger log = LoggerFactory.getLogger(FtFileService.class);
    //TODO 从配置文件中读取
    private static String basePath = "D:\\BaiduYunDownload";
