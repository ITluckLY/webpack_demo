...
public class TradeScenarioController extends BaseController {
    ...
    public String tradeScenariolist(TradeScenario tradeScenario, HttpServletRequest request, HttpServletResponse response, Model model) {//NOSONAR
        ...
        model.addAttribute("endTime", fmt.format(tradeScenario.getEndTime()));
        model.addAttribute("startTime", fmt.format(tradeScenario.getStartTime()));
        ...
        PageHelper.getInstance().getPage(tradeScenario.getClass(), request, response, model, resultList);
        return "modules/serviceinfo/TradeScenarioList";
    }
